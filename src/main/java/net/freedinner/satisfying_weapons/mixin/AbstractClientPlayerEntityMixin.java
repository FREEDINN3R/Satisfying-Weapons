...
public abstract class AbstractClientPlayerEntityMixin {
    ...
    private boolean includeModBows(ItemStack instance, Item item, Operation<Boolean> original) {
        return original.call(instance, item) || instance.isIn(ModTags.MOD_BOWS);
    }
}