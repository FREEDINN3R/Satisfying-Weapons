...
public abstract class ClientPlayerInteractionManagerMixin {
    ...
    private boolean summonBlackHoleForHP(boolean isOnCooldown, @Local(argsOnly = true) PlayerEntity player, @Local ItemStack itemStack, @Local(argsOnly = true) Hand hand) {
        if (!isOnCooldown) {
            return false;
        }
